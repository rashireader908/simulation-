      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <Card className="mb-6">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            By accessing and using Money Sandbox ("the Application"), you accept and agree 
        ...
        <Card className="mb-6">
          ...
          <div className="space-y-3 text-gray-700">
            <p className="leading-relaxed">
              Permission is granted to temporarily use Money Sandbox for personal, 
        ...
        <Card className="mb-6">
          ...
          <div className="space-y-4">
            <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-4">
              ...
              <p className="text-gray-700 leading-relaxed">
                Money Sandbox is a financial simulation tool, not financial advice. The 
            ...
            <p className="text-gray-700 leading-relaxed">
              The materials on Money Sandbox are provided on an 'as is' basis. We make no 
        ...
        <Card className="mb-6">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            In no event shall Money Sandbox or its suppliers be liable for any damages 
            (including, without limitation, damages for loss of data or profit, or due to 
            business interruption) arising out of the use or inability to use the materials 
            on Money Sandbox, even if Money Sandbox or a Money Sandbox authorized 
        ...
        <Card className="mb-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            The materials appearing on Money Sandbox could include technical, typographical, 
        ...
        <Card className="mb-6">
          ...
          <div className="space-y-3 text-gray-700">
            <p className="leading-relaxed">
              Since Money Sandbox stores all data locally on your device:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
        ...
        <Card className="mb-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            Money Sandbox has not reviewed all of the sites linked to the application and 
            is not responsible for the contents of any such linked site. The inclusion of 
            any link does not imply endorsement by Money Sandbox of the site. Use of any 
        ...
        <Card className="mb-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            Money Sandbox may revise these terms of service for its application at any time 
